...
parser = argparse.ArgumentParser("GID_dataset")
parser.add_argument('--data', type=str, default='/home/zhangmingwei/dataset/GID_10000', help='location of the data corpus')
...
parser.add_argument('--save', type=str, default='GID_deeplab', help='experiment name')
...
def main():
  ...
  for epoch in range(args.epochs):
    ...
    train_acc, train_obj, train_fscores, train_MIoU = train(train_queue, model, criterion, optimizer)
    logging.info('train_acc %f _fscores %f _MIoU %f', train_acc, train_fscores, train_MIoU)

    valid_acc, valid_obj, valid_fscares, valid_MIoU = infer(valid_queue, model, criterion)
    logging.info('valid_acc %f _fscores %f _MIoU %f', valid_acc, train_fscores, valid_MIoU)

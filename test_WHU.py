...
parser.add_argument('--model_path', type=str, default='/home/zhangmingwei/NAS/NAS-RSI1/train-WHU_Segnet-20200218-050906/weights.pt', help='path of pretrained model')

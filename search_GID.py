...
parser.add_argument('--data', type=str, default='/home/zhangmingwei/dataset/GID_1398', help='location of the data corpus')
...
parser.add_argument('--save', type=str, default='GID', help='experiment name')
